...
import ../base
import person/[person_en_US, person_ja_JP, person_fr_FR]
export base
...
proc firstName*(f: Faker): string =
  ...
  of "fr_FR": person_fr_FR.firstName(f)
...
proc firstNameFemale*(f: Faker): string =
  ...
  of "fr_FR": person_fr_FR.firstNameFemale(f)
...
proc firstNameMale*(f: Faker): string =
  ...
  of "fr_FR": person_fr_FR.firstNameMale(f)
...
proc lastName*(f: Faker): string =
  ...
  of "fr_FR": person_fr_FR.lastName(f)
...
proc lastNameFemale*(f: Faker): string =
  ...
  of "fr_FR": person_fr_FR.lastNameFemale(f)
...
proc lastNameMale*(f: Faker): string =
  ...
  of "fr_FR": person_fr_FR.lastNameMale(f)
...
proc nameFemale*(f: Faker): string =
  ...
  of "fr_FR": person_fr_FR.nameFemale(f)
...
proc nameMale*(f: Faker): string =
  ...
  of "fr_FR": person_fr_FR.nameMale(f)
...
proc prefix*(f: Faker): string =
  ...
  of "fr_FR": person_fr_FR.prefix(f)
...
proc prefixFemale*(f: Faker): string =
  ...
  of "fr_FR": person_fr_FR.prefixFemale(f)
...
proc prefixMale*(f: Faker): string =
  ...
  of "fr_FR": person_fr_FR.prefixMale(f)
...
proc suffix*(f: Faker): string =
  ...
  of "fr_FR": person_fr_FR.suffix(f)
...
proc suffixFemale*(f: Faker): string =
  ...
  of "fr_FR": person_fr_FR.suffixFemale(f)
...
proc suffixMale*(f: Faker): string =
  ...
  of "fr_FR": person_fr_FR.suffixMale(f)
